# 01_Dashboard_Detalle.py – Sidebar limpio (sin '¿Tiene PDC?')
...
URL_PEI_EDIT    = URL_UNIVERSO
URL_POI_EDIT    = URL_UNIVERSO
URL_PDC_EDIT    = URL_UNIVERSO
...
if plan == "PDC":
    ...
    k1.metric("Total de Entidades", f"{total}")
    k2.metric("Entidades con PDC", f"{con_pdc}")
